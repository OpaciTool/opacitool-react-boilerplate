  ...
  return (
    ...
    >
      <div className="relative flex rounded-lg">
        <img
          className={twMerge(
            "rounded-lg border transition-opacity duration-150 ease-in-out hover:cursor-pointer hover:opacity-90",
          )}
...
export function ReferenceObservationScreenshotsDialog({
  screenshots,
  isOpen,
  onClose,
  onScreenshotClick,
      ...
      <DialogTitle>
        <div className="flex justify-between">
          ...
          <span className="flex items-center space-x-4">
            {mode === "download" && (
              <>
                <Button plain onClick={() => setMode("edit")}>
                  Cancel
                </Button>
            ...
            >
              ...
              {mode === "edit" ? "Download" : "Download images"}
            </Button>
          </span>
        </div>
