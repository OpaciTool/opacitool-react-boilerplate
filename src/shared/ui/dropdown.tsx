...
export function DropdownItem({
  ...
  isDanger = false,
  ...props
}: { className?: string; isDanger?: boolean } & (
  ...
  const classes = clsx(
    ...
    // Text styles
    "text-left text-base/6 sm:text-sm/6 dark:text-white forced-colors:text-[CanvasText]",
    isDanger
    ...
    // Danger state
    isDanger &&
      "[&>[data-slot=icon]]:text-red-500 dark:[&>[data-slot=icon]]:text-red-400 data-[focus]:text-white dark:data-[focus]:text-white data-[focus]:bg-red-500 dark:data-[focus]:bg-red-400",
  );
