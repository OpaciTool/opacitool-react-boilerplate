...
const colors = {
  ...
  "brand-orange": [
    "[--switch-bg-ring:theme(colors.brand-orange.600/90%)] [--switch-bg:theme(colors.brand-orange.500)] dark:[--switch-bg-ring:transparent]",
    "[--switch:white] [--switch-ring:theme(colors.brand-orange.600/90%)] [--switch-shadow:theme(colors.brand-orange.900/20%)]",
  ],
  "brand-blue": [
    "[--switch-bg-ring:theme(colors.brand-blue.600/90%)] [--switch-bg:theme(colors.brand-blue.500)] dark:[--switch-bg-ring:transparent]",
    "[--switch:white] [--switch-ring:theme(colors.brand-blue.600/90%)] [--switch-shadow:theme(colors.brand-blue.900/20%)]",
  ],
};
